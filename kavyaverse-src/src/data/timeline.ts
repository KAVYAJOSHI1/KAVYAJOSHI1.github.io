...
export const timeline: TimelineStage[] = [
  ...
  },
  {
    ...
    place: "SIH 2025 · DRDO Sampada · Breach FinTech · Bhartiya Antariksh",
    detail: "Multi-time national hackathon champion across space mission planning, AI, IoT security, and FinTech tracks.",
    iconKey: "trophy",
    kind: "experience",
  },
  {
